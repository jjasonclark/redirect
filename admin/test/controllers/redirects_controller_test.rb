...
class RedirectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create redirect" do
    assert_difference('Redirect.count') do
      post redirects_url, params: { redirect: { counter_name: @redirect.counter_name, next: @redirect.next, regex: @redirect.regex, result: @redirect.result } }
    end
  ...
  test "should update redirect" do
    patch redirect_url(@redirect), params: { redirect: { counter_name: @redirect.counter_name, next: @redirect.next, regex: @redirect.regex, result: @redirect.result } }
